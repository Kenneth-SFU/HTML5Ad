...
lib.ssMetadata = [
		{name:"index_atlas_1", frames: [[0,178,688,120],[0,300,542,56],[544,300,364,80],[0,0,746,176],[690,235,260,56],[0,358,260,56],[262,358,260,56],[748,0,200,233],[910,293,100,100]]}
];
...
p.nominalBounds = new cjs.Rectangle(0,0,373,88);
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(38).to({_off:false},0).to({y:10},18,cjs.Ease.get(1)).wait(83).to({x:658},0).to({x:668},21,cjs.Ease.get(1)).to({_off:true},1).wait(166));
	...
	this.instance_2.setTransform(258.9,45.2,0.701,0.7007,0,0,0,49.9,50);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(161).to({_off:false},0).to({x:283.4},21,cjs.Ease.get(1)).to({_off:true},144).wait(1));
	this.timeline.addTween(cjs.Tween.get(instance_2Filter_3).wait(161).to(new cjs.ColorFilter(0,0,0,1,166,25,47,0), 0).to(new cjs.ColorFilter(1,1,1,1,0,0,0,0), 21,cjs.Ease.get(1)).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(mask_1).to({graphics:null,x:0,y:0}).wait(56).to({graphics:mask_1_graphics_56,x:364,y:125}).wait(271));

	// Text_1
	this.instance_3 = new lib.g_title_1("synched",0);
	this.instance_3.setTransform(255,27);
	this.instance_3._off = true;
	var instance_3Filter_4 = new cjs.ColorFilter(1,1,1,1,0,0,0,0);
	this.instance_3.filters = [instance_3Filter_4];
	this.instance_3.cache(-2,-2,348,89);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(37).to({_off:false},0).to({y:6},19,cjs.Ease.get(1)).wait(83).to({regX:111.3,regY:31.4,x:366.3,y:37.4},0).to({startPosition:0},20).to({_off:true},2).wait(166));
	this.timeline.addTween(cjs.Tween.get(instance_3Filter_4).wait(37).to(new cjs.ColorFilter(0,0,0,1,166,25,47,0), 0).to(new cjs.ColorFilter(1,1,1,1,0,0,0,0), 19,cjs.Ease.get(1)).wait(83).to(new cjs.ColorFilter(0,0,0,1,166,25,47,0), 20).wait(166));

	// Mask (mask)
	var mask_2 = new cjs.Shape();
	mask_2._off = true;
	var mask_2_graphics_173 = new cjs.Graphics().p("A/AHCIAAuDMA+BAAAIAAODg");

	this.timeline.addTween(cjs.Tween.get(mask_2).to({graphics:null,x:0,y:0}).wait(173).to({graphics:mask_2_graphics_173,x:526.025,y:45}).wait(154));

	// Text_2
	this.instance_4 = new lib.g_contenttxt_1("synched",0);
	this.instance_4.setTransform(125.4,44.15,1,1,0,0,0,96.5,45);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(173).to({_off:false},0).to({x:434},25,cjs.Ease.get(1)).to({_off:true},128).wait(1));

	// btn_CTA
	this.instance_5 = new lib.btn_CTA();
	this.instance_5.setTransform(30,68);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(194).to({_off:false},0).to({y:58},23,cjs.Ease.get(1)).to({_off:true},109).wait(1));
	...
	this.filterCacheList.push({instance: this.instance_2, startFrame:162, endFrame:182, x:-2, y:-2, w:104, h:104});
	this.filterCacheList.push({instance: this.instance_3, startFrame:37, endFrame:37, x:-2, y:-2, w:348, h:89});
	this.filterCacheList.push({instance: this.instance_3, startFrame:0, endFrame:0, x:-2, y:-2, w:348, h:89});
	this.filterCacheList.push({instance: this.instance_3, startFrame:38, endFrame:56, x:-2, y:-2, w:348, h:89});
	this.filterCacheList.push({instance: this.instance_3, startFrame:139, endFrame:139, x:-2, y:-2, w:348, h:89});
	this.filterCacheList.push({instance: this.instance_3, startFrame:140, endFrame:159, x:-2, y:-2, w:348, h:89});
...
p.nominalBounds = new cjs.Rectangle(0,0,728,154.7);
// library properties:
lib.properties = {
