...
lib.ssMetadata = [
		{name:"banner_970x250_atlas_1", frames: [[0,252,816,268],[818,252,742,200],[1562,354,200,100],[1100,454,202,51],[1562,252,425,100],[1764,354,280,66],[1764,422,280,66],[818,454,280,66],[0,0,970,250],[972,0,970,250]]}
];
...
p.nominalBounds = new cjs.Rectangle(0,0,408,134);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-371.15,0,0.5,0.5);
...
p.nominalBounds = new cjs.Rectangle(-371.1,0,371,100);
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape}]}).to({state:[{t:this.shape_1}]},1).to({state:[{t:this.shape_2}]},1).to({state:[{t:this.shape_3}]},1).to({state:[{t:this.shape_4}]},1).to({state:[{t:this.shape_5}]},1).to({state:[{t:this.shape_6}]},1).to({state:[{t:this.shape_7}]},1).to({state:[{t:this.shape_8}]},1).to({state:[{t:this.shape_9}]},1).to({state:[{t:this.shape_10}]},1).to({state:[{t:this.shape_11}]},1).to({state:[{t:this.shape_12}]},1).to({state:[{t:this.shape_13}]},1).to({state:[{t:this.shape_14}]},1).to({state:[{t:this.shape_15}]},1).to({state:[{t:this.shape_16}]},1).to({state:[{t:this.shape_17}]},1).to({state:[{t:this.shape_18}]},1).to({state:[{t:this.shape_19}]},1).to({state:[{t:this.shape_20}]},1).to({state:[{t:this.shape_21}]},1).to({state:[{t:this.shape_22}]},1).to({state:[{t:this.shape_23}]},1).to({state:[{t:this.shape_24}]},1).to({state:[{t:this.shape_25}]},1).to({state:[{t:this.shape_26}]},1).to({state:[{t:this.shape_27}]},1).to({state:[{t:this.shape_28}]},1).to({state:[{t:this.shape_29}]},1).to({state:[]},1).wait(235));
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.shape_30}]},244).to({state:[{t:this.shape_31}]},1).to({state:[{t:this.shape_32}]},1).to({state:[{t:this.shape_33}]},1).to({state:[{t:this.shape_34}]},1).to({state:[{t:this.shape_35}]},1).to({state:[{t:this.shape_36}]},1).to({state:[{t:this.shape_37}]},1).to({state:[{t:this.shape_38}]},1).to({state:[{t:this.shape_39}]},1).to({state:[{t:this.shape_40}]},1).to({state:[{t:this.shape_41}]},1).to({state:[{t:this.shape_42}]},1).to({state:[{t:this.shape_43}]},1).to({state:[{t:this.shape_44}]},1).to({state:[{t:this.shape_45}]},1).to({state:[{t:this.shape_46}]},1).to({state:[{t:this.shape_47}]},1).to({state:[{t:this.shape_48}]},1).to({state:[{t:this.shape_49}]},1).wait(2));
	...
	this.shape_51.graphics.f("rgba(87,87,87,0.188)").s().p("EhLxATiMAAAgnDMCXjAAAMAAAAnDg");
	this.shape_51.setTransform(485,125);

	this.shape_52 = new cjs.Shape();
	this.shape_52.graphics.f("rgba(120,120,120,0.361)").s().p("EhLxATiMAAAgnDMCXjAAAMAAAAnDg");
	this.shape_52.setTransform(485,125);

	this.shape_53 = new cjs.Shape();
	this.shape_53.graphics.f("rgba(149,149,149,0.51)").s().p("EhLxATiMAAAgnDMCXjAAAMAAAAnDg");
	this.shape_53.setTransform(485,125);

	this.shape_54 = new cjs.Shape();
	this.shape_54.graphics.f("rgba(174,174,174,0.643)").s().p("EhLxATiMAAAgnDMCXjAAAMAAAAnDg");
	this.shape_54.setTransform(485,125);

	this.shape_55 = new cjs.Shape();
	this.shape_55.graphics.f("rgba(195,195,195,0.753)").s().p("EhLxATiMAAAgnDMCXjAAAMAAAAnDg");
	this.shape_55.setTransform(485,125);

	this.shape_56 = new cjs.Shape();
	this.shape_56.graphics.f("rgba(212,212,212,0.843)").s().p("EhLxATiMAAAgnDMCXjAAAMAAAAnDg");
	this.shape_56.setTransform(485,125);

	this.shape_57 = new cjs.Shape();
	this.shape_57.graphics.f("rgba(226,226,226,0.918)").s().p("EhLxATiMAAAgnDMCXjAAAMAAAAnDg");
	this.shape_57.setTransform(485,125);

	this.shape_58 = new cjs.Shape();
	this.shape_58.graphics.f("rgba(236,236,236,0.969)").s().p("EhLxATiMAAAgnDMCXjAAAMAAAAnDg");
	this.shape_58.setTransform(485,125);

	this.shape_59 = new cjs.Shape();
	this.shape_59.graphics.f("#F2F2F2").s().p("EhLxATiMAAAgnDMCXjAAAMAAAAnDg");
	this.shape_59.setTransform(485,125);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.shape_50}]},104).to({state:[{t:this.shape_51}]},1).to({state:[{t:this.shape_52}]},1).to({state:[{t:this.shape_53}]},1).to({state:[{t:this.shape_54}]},1).to({state:[{t:this.shape_55}]},1).to({state:[{t:this.shape_56}]},1).to({state:[{t:this.shape_57}]},1).to({state:[{t:this.shape_58}]},1).to({state:[{t:this.shape_59}]},1).to({state:[]},1).wait(151));
	...
	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:null,x:0,y:0}).wait(52).to({graphics:mask_graphics_52,x:200,y:125}).wait(213));

	// Text_SFU_Medical_School
	this.instance = new lib.g_txtSFUMedicalSchool("synched",0);
	this.instance.setTransform(592.7,216,1,1,0,0,0,-162.3,77);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(52).to({_off:false},0).to({x:242.2},14,cjs.Ease.get(1)).to({_off:true},48).wait(151));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(34).to({_off:false},0).to({_off:true},80).wait(151));
	...
	this.timeline.addTween(cjs.Tween.get(mask_2).to({graphics:null,x:0,y:0}).wait(1).to({graphics:mask_2_graphics_1,x:485,y:125.025}).wait(264));

	// Red_Bg__Animate_
	this.shape_60 = new cjs.Shape();
	this.shape_60.graphics.f("#CC0633").s().p("AgxTiMAAAgnDIBjAAMAAAAnDg");
	this.shape_60.setTransform(-5,125);

	this.shape_61 = new cjs.Shape();
	this.shape_61.graphics.f("#CC0633").s().p("AkPTiMAAAgnDIIfAAMAAAAnDg");
	this.shape_61.setTransform(18.4,125);

	this.shape_62 = new cjs.Shape();
	this.shape_62.graphics.f("#CC0633").s().p("AnhTiMAAAgnDIPDAAMAAAAnDg");
	this.shape_62.setTransform(40.4,125);

	this.shape_63 = new cjs.Shape();
	this.shape_63.graphics.f("#CC0633").s().p("AqlTiMAAAgnDIVKAAMAAAAnDg");
	this.shape_63.setTransform(60.95,125);

	this.shape_64 = new cjs.Shape();
	this.shape_64.graphics.f("#CC0633").s().p("AtbTiMAAAgnDIa3AAMAAAAnDg");
	this.shape_64.setTransform(80.125,125);

	this.shape_65 = new cjs.Shape();
	this.shape_65.graphics.f("#CC0633").s().p("AwETiMAAAgnDMAgIAAAMAAAAnDg");
	this.shape_65.setTransform(97.85,125);

	this.shape_66 = new cjs.Shape();
	this.shape_66.graphics.f("#CC0633").s().p("AyfTiMAAAgnDMAk/AAAMAAAAnDg");
	this.shape_66.setTransform(114.175,125);

	this.shape_67 = new cjs.Shape();
	this.shape_67.graphics.f("#CC0633").s().p("A0sTiMAAAgnDMApZAAAMAAAAnDg");
	this.shape_67.setTransform(129.075,125);

	this.shape_68 = new cjs.Shape();
	this.shape_68.graphics.f("#CC0633").s().p("A2sTiMAAAgnDMAtaAAAMAAAAnDg");
	this.shape_68.setTransform(142.55,125);

	this.shape_69 = new cjs.Shape();
	this.shape_69.graphics.f("#CC0633").s().p("A4fTiMAAAgnDMAw/AAAMAAAAnDg");
	this.shape_69.setTransform(154.6,125);

	this.shape_70 = new cjs.Shape();
	this.shape_70.graphics.f("#CC0633").s().p("A6FTiMAAAgnDMA0KAAAMAAAAnDg");
	this.shape_70.setTransform(165.25,125);

	this.shape_71 = new cjs.Shape();
	this.shape_71.graphics.f("#CC0633").s().p("A7cTiMAAAgnDMA25AAAMAAAAnDg");
	this.shape_71.setTransform(174.475,125);

	this.shape_72 = new cjs.Shape();
	this.shape_72.graphics.f("#CC0633").s().p("A8mTiMAAAgnDMA5NAAAMAAAAnDg");
	this.shape_72.setTransform(182.275,125);

	this.shape_73 = new cjs.Shape();
	this.shape_73.graphics.f("#CC0633").s().p("A9jTiMAAAgnDMA7HAAAMAAAAnDg");
	this.shape_73.setTransform(188.65,125);

	this.shape_74 = new cjs.Shape();
	this.shape_74.graphics.f("#CC0633").s().p("A+STiMAAAgnDMA8lAAAMAAAAnDg");
	this.shape_74.setTransform(193.625,125);

	this.shape_75 = new cjs.Shape();
	this.shape_75.graphics.f("#CC0633").s().p("A+0TiMAAAgnDMA9pAAAMAAAAnDg");
	this.shape_75.setTransform(197.15,125);

	this.shape_76 = new cjs.Shape();
	this.shape_76.graphics.f("#CC0633").s().p("A/ITiMAAAgnDMA+RAAAMAAAAnDg");
	this.shape_76.setTransform(199.275,125);

	this.shape_77 = new cjs.Shape();
	this.shape_77.graphics.f("#CC0633").s().p("A/PTiMAAAgnDMA+fAAAMAAAAnDg");
	this.shape_77.setTransform(200,125);

	var maskedShapeInstanceList = [this.shape_60,this.shape_61,this.shape_62,this.shape_63,this.shape_64,this.shape_65,this.shape_66,this.shape_67,this.shape_68,this.shape_69,this.shape_70,this.shape_71,this.shape_72,this.shape_73,this.shape_74,this.shape_75,this.shape_76,this.shape_77];

	for(var shapedInstanceItr = 0; shapedInstanceItr < maskedShapeInstanceList.length; shapedInstanceItr++) {
		maskedShapeInstanceList[shapedInstanceItr].mask = mask_2;
	}

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.shape_60}]},34).to({state:[{t:this.shape_61}]},1).to({state:[{t:this.shape_62}]},1).to({state:[{t:this.shape_63}]},1).to({state:[{t:this.shape_64}]},1).to({state:[{t:this.shape_65}]},1).to({state:[{t:this.shape_66}]},1).to({state:[{t:this.shape_67}]},1).to({state:[{t:this.shape_68}]},1).to({state:[{t:this.shape_69}]},1).to({state:[{t:this.shape_70}]},1).to({state:[{t:this.shape_71}]},1).to({state:[{t:this.shape_72}]},1).to({state:[{t:this.shape_73}]},1).to({state:[{t:this.shape_74}]},1).to({state:[{t:this.shape_75}]},1).to({state:[{t:this.shape_76}]},1).to({state:[{t:this.shape_77}]},1).to({state:[]},63).wait(151));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(1).to({_off:false},0).to({_off:true},113).wait(151));

	// Mask (mask)
	var mask_3 = new cjs.Shape();
	mask_3._off = true;
	var mask_3_graphics_114 = new cjs.Graphics().p("EhLxATiMAAAgnDMCXjAAAMAAAAnDg");

	this.timeline.addTween(cjs.Tween.get(mask_3).to({graphics:null,x:0,y:0}).wait(114).to({graphics:mask_3_graphics_114,x:485,y:125}).wait(151));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(151).to({_off:false},0).to({y:202.5},21,cjs.Ease.get(0.9)).to({_off:true},91).wait(2));
	this.timeline.addTween(cjs.Tween.get(instance_3Filter_1).wait(151).to(new cjs.ColorFilter(0,0,0,1,255,255,255,0), 0).to(new cjs.ColorFilter(1,1,1,1,0,0,0,0), 21,cjs.Ease.get(0.9)).wait(2));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(151).to({_off:false},0).to({regY:0.1,y:1.1},20,cjs.Ease.get(1)).to({_off:true},92).wait(2));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(122).to({_off:false},0).to({x:-3.25},15,cjs.Ease.get(0.9)).to({_off:true},126).wait(2));

	// REd_Bg
	this.shape_78 = new cjs.Shape();
	this.shape_78.graphics.f("#CC0633").s().p("AgdKMIAA0YIA7AAIAAK/IgnAAIAAJZg");
	this.shape_78.setTransform(-3,160.75);

	this.shape_79 = new cjs.Shape();
	this.shape_79.graphics.f("#CC0633").s().p("AjmKNIAA0ZIGiAAIAAK0IArAAIAAJlg");
	this.shape_79.setTransform(17.75,160.725);

	this.shape_80 = new cjs.Shape();
	this.shape_80.graphics.f("#CC0633").s().p("Am2KNIAA0ZIL1AAIgBKqIB5AAIAAJvg");
	this.shape_80.setTransform(39.175,160.7);

	this.shape_81 = new cjs.Shape();
	this.shape_81.graphics.f("#CC0633").s().p("Ap6KNIAA0ZIQzAAIgBKgIDDAAIAAJ5g");
	this.shape_81.setTransform(59.325,160.675);

	this.shape_82 = new cjs.Shape();
	this.shape_82.graphics.f("#CC0633").s().p("AsxKNIAA0ZIVdAAIgCKXIEIAAIAAKCg");
	this.shape_82.setTransform(78.15,160.65);

	this.shape_83 = new cjs.Shape();
	this.shape_83.graphics.f("#CC0633").s().p("AvcKOIAA0bIZyAAIgCKQIFJAAIAAKLg");
	this.shape_83.setTransform(95.7,160.625);

	this.shape_84 = new cjs.Shape();
	this.shape_84.graphics.f("#CC0633").s().p("Ax5KOIAA0bIdyAAIgDKIIGEAAIAAKTg");
	this.shape_84.setTransform(111.95,160.6);

	this.shape_85 = new cjs.Shape();
	this.shape_85.graphics.f("#CC0633").s().p("A0KKOIAA0bMAheAAAIgDKBIG6AAIAAKag");
	this.shape_85.setTransform(126.875,160.6);

	this.shape_86 = new cjs.Shape();
	this.shape_86.graphics.f("#CC0633").s().p("A2PKOIAA0bMAk2AAAIgDJ7IHsAAIAAKgg");
	this.shape_86.setTransform(140.525,160.575);

	this.shape_87 = new cjs.Shape();
	this.shape_87.graphics.f("#CC0633").s().p("A4HKOIAA0bMAn5AAAIgEJ1IIaAAIAAKmg");
	this.shape_87.setTransform(152.875,160.575);

	this.shape_88 = new cjs.Shape();
	this.shape_88.graphics.f("#CC0633").s().p("A5yKOIAA0bMAqnAAAIgEJvIJCAAIAAKsg");
	this.shape_88.setTransform(163.925,160.55);

	this.shape_89 = new cjs.Shape();
	this.shape_89.graphics.f("#CC0633").s().p("A7RKOIAA0bMAtBAAAIgEJqIJmAAIAAKxg");
	this.shape_89.setTransform(173.675,160.55);

	this.shape_90 = new cjs.Shape();
	this.shape_90.graphics.f("#CC0633").s().p("A8jKPIAA0dMAvHAAAIgFJnIKFAAIAAK2g");
	this.shape_90.setTransform(182.125,160.525);

	this.shape_91 = new cjs.Shape();
	this.shape_91.graphics.f("#CC0633").s().p("A9oKPIAA0dMAw3AAAIgFJkIKfAAIAAK5g");
	this.shape_91.setTransform(189.275,160.525);

	this.shape_92 = new cjs.Shape();
	this.shape_92.graphics.f("#CC0633").s().p("A+hKPIAA0dMAyUAAAIgFJhIK0AAIAAK8g");
	this.shape_92.setTransform(195.1,160.5);

	this.shape_93 = new cjs.Shape();
	this.shape_93.graphics.f("#CC0633").s().p("A/NKPIAA0dMAzcAAAIgGJfILFAAIAAK+g");
	this.shape_93.setTransform(199.65,160.5);

	this.shape_94 = new cjs.Shape();
	this.shape_94.graphics.f("#CC0633").s().p("A/tKPIAA0dMA0PAAAIgFJdILRAAIAALAg");
	this.shape_94.setTransform(202.925,160.5);

	this.shape_95 = new cjs.Shape();
	this.shape_95.graphics.f("#CC0633").s().p("EggAAKPIAA0dMA0uAAAIgFJcILXAAIAALBg");
	this.shape_95.setTransform(204.85,160.5);

	this.shape_96 = new cjs.Shape();
	this.shape_96.graphics.f("#CC0633").s().p("EggGAKPIAA0dMA04AAAIgFJcILaAAIAALBg");
	this.shape_96.setTransform(205.5,160.5);

	var maskedShapeInstanceList = [this.shape_78,this.shape_79,this.shape_80,this.shape_81,this.shape_82,this.shape_83,this.shape_84,this.shape_85,this.shape_86,this.shape_87,this.shape_88,this.shape_89,this.shape_90,this.shape_91,this.shape_92,this.shape_93,this.shape_94,this.shape_95,this.shape_96];

	for(var shapedInstanceItr = 0; shapedInstanceItr < maskedShapeInstanceList.length; shapedInstanceItr++) {
		maskedShapeInstanceList[shapedInstanceItr].mask = mask_3;
	}

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.shape_78}]},114).to({state:[{t:this.shape_79}]},1).to({state:[{t:this.shape_80}]},1).to({state:[{t:this.shape_81}]},1).to({state:[{t:this.shape_82}]},1).to({state:[{t:this.shape_83}]},1).to({state:[{t:this.shape_84}]},1).to({state:[{t:this.shape_85}]},1).to({state:[{t:this.shape_86}]},1).to({state:[{t:this.shape_87}]},1).to({state:[{t:this.shape_88}]},1).to({state:[{t:this.shape_89}]},1).to({state:[{t:this.shape_90}]},1).to({state:[{t:this.shape_91}]},1).to({state:[{t:this.shape_92}]},1).to({state:[{t:this.shape_93}]},1).to({state:[{t:this.shape_94}]},1).to({state:[{t:this.shape_95}]},1).to({state:[{t:this.shape_96}]},1).to({state:[]},131).wait(2));

	// Pic_
	this.instance_6 = new lib.gpic02("synched",0);
	this.instance_6.setTransform(485,125,1,1,0,0,0,485,125);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(114).to({_off:false},0).to({startPosition:0},56,cjs.Ease.get(0.9)).to({_off:true},93).wait(2));
	this.timeline.addTween(cjs.Tween.get(instance_6Filter_2).wait(114).to(new cjs.ColorFilter(0.75,0.75,0.75,1,180,180,180,0), 0).to(new cjs.ColorFilter(1,1,1,1,0,0,0,0), 56,cjs.Ease.get(0.9)).wait(2));

	this.filterCacheList = [];
	this.filterCacheList.push({instance: this.instance_3, startFrame:151, endFrame:151, x:-3, y:-3, w:172, h:57});
	this.filterCacheList.push({instance: this.instance_3, startFrame:0, endFrame:0, x:-3, y:-3, w:172, h:57});
	this.filterCacheList.push({instance: this.instance_3, startFrame:152, endFrame:172, x:-3, y:-3, w:172, h:57});
	this.filterCacheList.push({instance: this.instance_3, startFrame:173, endFrame:263, x:-3, y:-3, w:172, h:57});
	this.filterCacheList.push({instance: this.instance_3, startFrame:263, endFrame:265, x:-3, y:-3, w:172, h:57});
	this.filterCacheList.push({instance: this.instance_6, startFrame:114, endFrame:114, x:-2, y:-2, w:974, h:254});
	this.filterCacheList.push({instance: this.instance_6, startFrame:0, endFrame:0, x:-2, y:-2, w:974, h:254});
	this.filterCacheList.push({instance: this.instance_6, startFrame:115, endFrame:170, x:-2, y:-2, w:974, h:254});
	this._renderFirstFrame();
