...
if (reversed == null) { reversed = false; }
	...
	this.shape.graphics.f("#FFFFFF").s().p("");
	this.shape.setTransform(125.95,19.9);
...
p.nominalBounds = new cjs.Rectangle(3.1,7,245.70000000000002,25.9);
...
if (reversed == null) { reversed = false; }
	...
	// Text
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#000000").s().p("");
	this.shape.setTransform(121.925,103.675);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	// Bg
	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("A1UMaIAAmTIgBAAIAAmBIABAAIAAmeIgBAAIAAmBIU/AAIAAGAISpAAIAAF9IBWAAIAAF6IBtAAIAAG8g");
	this.shape_1.setTransform(112.575,102.65);
...
p.nominalBounds = new cjs.Rectangle(-24,23.3,273.2,158.79999999999998);
...
if (reversed == null) { reversed = false; }
	...
	// Text
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("");
	this.shape.setTransform(146.575,21.8);
...
p.nominalBounds = new cjs.Rectangle(3.1,5.6,287,32.4);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(175,21.95,1,1,180,0,0,26,26);

	this.instance_1 = new lib.g_arrow("synched",0);
	this.instance_1.setTransform(63,142.05,1,1,0,0,0,26,26);
...
if (reversed == null) { reversed = false; }
	...
	this.instance_3.setTransform(-344.95,68.5,1,1,0,0,0,-66.5,28);
	...
	this.instance_4.setTransform(-359.2,228,1,1,0,0,0,-66.5,28);
...
p.nominalBounds = new cjs.Rectangle(-139.6,125,449.6,125);
// library properties:
lib.properties = {
