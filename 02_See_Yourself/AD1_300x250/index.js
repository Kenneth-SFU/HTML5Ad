...
if (reversed == null) { reversed = false; }
	...
	this.shape_2.graphics.f("#FFFFFF").s().p("");
	this.shape_2.setTransform(106.475,178.875);
...
if (reversed == null) { reversed = false; }
	...
	// Text
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("");
	this.shape.setTransform(79.075,43.675);
...
p.nominalBounds = new cjs.Rectangle(2.7,5.8,152.8,75.8);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(254,52.45,1,1,180,0,0,26,26);

	this.instance_1 = new lib.g_arrow("synched",0);
	this.instance_1.setTransform(69,226.05,1,1,0,0,0,26,26);
...
if (reversed == null) { reversed = false; }
	...
	this.instance_4.setTransform(-227.2,44,1,1,0,0,0,-66.5,28);
...
p.nominalBounds = new cjs.Rectangle(-8,125,318,125);
// library properties:
lib.properties = {
