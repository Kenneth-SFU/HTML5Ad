...
if (reversed == null) { reversed = false; }
	...
	// Text
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#000000").s().p("");
	this.shape.setTransform(110.875,22.675);
...
p.nominalBounds = new cjs.Rectangle(3,5.8,215.8,33.800000000000004);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(257.5,83.45,1,1,180,0,0,26,26);

	this.instance_1 = new lib.g_arrow("synched",0);
	this.instance_1.setTransform(180,181.05,1,1,0,0,0,26,26);
...
if (reversed == null) { reversed = false; }
	...
	this.instance_3.setTransform(-344.95,108.5,1,1,0,0,0,-66.5,28);
	...
	this.instance_4.setTransform(-227.7,32);
	this.instance_4._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(11).to({_off:false},0).to({x:-2.95},21,cjs.Ease.get(1)).to({_off:true},72).wait(250));
...
p.nominalBounds = new cjs.Rectangle(-74.7,125,384.7,125);
// library properties:
lib.properties = {
