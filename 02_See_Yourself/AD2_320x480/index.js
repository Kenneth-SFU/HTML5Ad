...
if (reversed == null) { reversed = false; }
	...
	// Text
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("");
	this.shape.setTransform(110.2,20.95);
...
p.nominalBounds = new cjs.Rectangle(2.9,-27.3,214.6,96.5);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(295,48.45,1,1,180,0,0,26,26);

	this.instance_1 = new lib.g_arrow("synched",0);
	this.instance_1.setTransform(164,183.05,1,1,0,0,0,26,26);
...
if (reversed == null) { reversed = false; }
	...
	this.instance_4.setTransform(-289.2,386.75,1,1,0,0,0,-66.5,28);
