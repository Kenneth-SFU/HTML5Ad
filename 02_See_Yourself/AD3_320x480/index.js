...
if (reversed == null) { reversed = false; }
	...
	// Text
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#000000").s().p("");
	this.shape.setTransform(130.15,65.675);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	// Bg
	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("A2jGgIAAm+IgBAAIAAmBMAkDAAAIAAGAIJFAAIAAG/g");
	this.shape_1.setTransform(120.45,64.875);
...
p.nominalBounds = new cjs.Rectangle(-24,23.3,288.9,83.2);
...
if (reversed == null) { reversed = false; }
	...
	// Text
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#000000").s().p("");
	this.shape.setTransform(138.725,-6.05);
...
p.nominalBounds = new cjs.Rectangle(3.2,-27.3,271.1,42.5);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(295,116.95,1,1,180,0,0,26,26);

	this.instance_1 = new lib.g_arrow("synched",0);
	this.instance_1.setTransform(186,223.05,1,1,0,0,0,26,26);
...
if (reversed == null) { reversed = false; }
	...
	this.instance_4.setTransform(-349.2,105.65,1,1,0,0,0,-66.5,28);
...
p.nominalBounds = new cjs.Rectangle(-119.5,240,449.5,240);
// library properties:
lib.properties = {
