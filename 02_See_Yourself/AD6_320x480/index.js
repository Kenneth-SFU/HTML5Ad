...
(lib.g_txt02AD6 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	// Text
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#000000").s().p("");
	this.shape.setTransform(135.75,93.975);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	// Bg
	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("A3XK4IABjaIgBAAIAAmBIAAAAIABmeIgBAAIAAl3MAuvAAAIAAGGImHAAIAAFJIsfAAIAAETIA2AAIAAGOg");
	this.shape_1.setTransform(125.625,93.9);
...
p.nominalBounds = new cjs.Rectangle(-24,24.3,299.3,139.29999999999998);


(lib.g_txt01AD6 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	// Text
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("");
	this.shape.setTransform(148.575,27.95);
...
p.nominalBounds = new cjs.Rectangle(3.5,6.7,290.2,42.5);
...
(lib.gpic6 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.instance.setTransform(190.95,94.05,1,1,89.9948,0,0,26,26.1);

	this.instance_1 = new lib.g_arrow("synched",0);
	this.instance_1.setTransform(295,252.95,1,1,-89.9948,0,0,26.1,25.9);
...
p.nominalBounds = new cjs.Rectangle(0,0,321.1,480);
...
if (reversed == null) { reversed = false; }
	...
	// text_02__Ad06
	this.instance_3 = new lib.g_txt02AD6("synched",0);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(79).to({_off:false},0).to({x:-42.5},25,cjs.Ease.get(1)).wait(97).to({startPosition:0},0).to({x:-344.95},21,cjs.Ease.get(1)).to({_off:true},3).wait(147));
	...
	// Text_01___AD6
	this.instance_4 = new lib.g_txt01AD6("single",0);
	this.instance_4.setTransform(-362.2,414.75,1,1,0,0,0,-66.5,28);
	this.instance_4._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(11).to({_off:false},0).to({x:-69.45},21,cjs.Ease.get(1)).to({_off:true},72).wait(268));

	// Photo_AD6
	this.instance_5 = new lib.gpic6("single",0);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_5).to({startPosition:0},18,cjs.Ease.get(1)).to({_off:true},86).wait(268));
	this.timeline.addTween(cjs.Tween.get(instance_5Filter_1).to(new cjs.ColorFilter(1,1,1,1,0,0,0,0), 18,cjs.Ease.get(1)).wait(268));
...
p.nominalBounds = new cjs.Rectangle(-132.2,240,462.2,240);
// library properties:
lib.properties = {
