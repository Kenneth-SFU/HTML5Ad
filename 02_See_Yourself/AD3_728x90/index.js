...
if (reversed == null) { reversed = false; }
	...
	// Text
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#000000").s().p("");
	this.shape.setTransform(206.325,18.725);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	// Bg
	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("A2UDGIqUAAIAAmLIKUAAMA29AAAIAAGLg");
	this.shape_1.setTransform(206.375,18.525);
...
p.nominalBounds = new cjs.Rectangle(-2.5,-1.2,417.8,39.5);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(696.15,11.95,1,1,180,0,0,26,26);

	this.instance_1 = new lib.g_arrow("synched",0);
	this.instance_1.setTransform(600.1,78.05,1,1,0,0,0,26,26);
...
if (reversed == null) { reversed = false; }
	...
	this.instance_3.setTransform(-483.7,46.5,1,1,0,0,0,-66.5,28);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(79).to({_off:false},0).to({x:60},25,cjs.Ease.get(1)).wait(79).to({startPosition:0},0).to({x:-483.7},21,cjs.Ease.get(1)).to({_off:true},3).wait(147));
	...
	this.instance_4.setTransform(647.45,53.75,1,1,0,0,0,-66.5,28);
...
p.nominalBounds = new cjs.Rectangle(364,45,374,45.099999999999994);
// library properties:
lib.properties = {
