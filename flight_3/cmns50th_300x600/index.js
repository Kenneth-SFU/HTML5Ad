...
lib.ssMetadata = [
		{name:"index_atlas_1", frames: [[0,214,567,100],[0,398,488,51],[0,316,364,80],[0,0,419,212],[366,316,420,56],[569,235,420,56],[490,374,420,56],[421,0,100,100],[569,0,200,233]]}
];
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(87).to({_off:false},0).to({x:182},25,cjs.Ease.get(1)).to({_off:true},162).wait(4));
