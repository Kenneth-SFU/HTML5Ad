...
lib.ssMetadata = [
		{name:"index_atlas_1", frames: [[0,120,688,120],[0,242,542,56],[544,242,364,80],[0,0,774,118],[0,300,260,56],[262,300,260,56],[524,324,260,56],[910,235,100,100],[776,0,200,233]]}
];
...
p.nominalBounds = new cjs.Rectangle(0,0,387,59);
...
if (reversed == null) { reversed = false; }
	...
	this.instance_4.setTransform(35.4,60.6,1,1,0,0,0,96.5,45);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(173).to({_off:false},0).to({x:431},25,cjs.Ease.get(1)).to({_off:true},128).wait(1));
