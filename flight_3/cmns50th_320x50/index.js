...
lib.ssMetadata = [
		{name:"index_atlas_1", frames: [[0,252,381,42],[0,174,421,76],[0,296,381,42],[423,235,291,64],[0,88,554,84],[0,0,554,86],[758,0,260,56],[758,58,260,56],[758,116,260,56],[758,174,100,100],[556,0,200,233]]}
];
...
p.nominalBounds = new cjs.Rectangle(0,0,277,43);
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1).to({_off:false},0).to({y:18.1},24,cjs.Ease.get(1)).wait(63).to({startPosition:0},0).to({y:-13.9},24).to({_off:true},2).wait(345));
	this.timeline.addTween(cjs.Tween.get(instanceFilter_1).wait(1).to(new cjs.ColorFilter(0,0,0,1,166,25,47,0), 0).to(new cjs.ColorFilter(1,1,1,1,0,0,0,0), 24,cjs.Ease.get(1)).wait(63).to(new cjs.ColorFilter(0,0,0,1,166,25,46,0), 24).wait(345));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(46).to({_off:false},0).to({startPosition:0},18,cjs.Ease.get(1)).wait(135).to({regX:82,regY:30,x:350.25,y:33.6},0).to({x:362.25},21,cjs.Ease.get(1)).to({_off:true},1).wait(238));
	this.timeline.addTween(cjs.Tween.get(instance_1Filter_2).wait(46).to(new cjs.ColorFilter(0,0,0,1,166,25,47,0), 0).to(new cjs.ColorFilter(1,1,1,1,0,0,0,0), 18,cjs.Ease.get(1)).wait(135).to(new cjs.ColorFilter(0,0,0,1,166,25,47,0), 21,cjs.Ease.get(1)).wait(238));
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.shape_23},{t:this.shape_22},{t:this.shape_21},{t:this.shape_20}]},14).to({state:[]},96).wait(349));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(221).to({_off:false},0).to({x:271.95},24,cjs.Ease.get(1)).to({_off:true},213).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(mask_1).to({graphics:null,x:0,y:0}).wait(111).to({graphics:mask_1_graphics_111,x:150,y:125}).wait(348));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(111).to({_off:false},0).to({x:10},23,cjs.Ease.get(1)).wait(67).to({startPosition:0},0).to({x:-19},20).to({_off:true},2).wait(236));
	this.timeline.addTween(cjs.Tween.get(instance_3Filter_4).wait(111).to(new cjs.ColorFilter(0,0,0,1,166,25,47,0), 0).to(new cjs.ColorFilter(1,1,1,1,0,0,0,0), 23,cjs.Ease.get(1)).wait(67).to(new cjs.ColorFilter(0,0,0,1,166,25,47,0), 20).wait(236));
	...
	this.timeline.addTween(cjs.Tween.get(mask_2).to({graphics:null,x:0,y:0}).wait(233).to({graphics:mask_2_graphics_233,x:133.075,y:25}).wait(226));

	// btn_CTA
	this.instance_4 = new lib.btn_CTA();
	this.instance_4.setTransform(6,30.1);
	this.instance_4._off = true;
	var instance_4Filter_5 = new cjs.ColorFilter(1,1,1,1,0,0,0,0);
	this.instance_4.filters = [instance_4Filter_5];
	this.instance_4.cache(-3,-4,136,33);
	new cjs.ButtonHelper(this.instance_4, 0, 1, 2, false, new lib.btn_CTA(), 3);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(334).to({_off:false},0).to({y:24.1},23,cjs.Ease.get(1)).to({_off:true},101).wait(1));
	this.timeline.addTween(cjs.Tween.get(instance_4Filter_5).wait(334).to(new cjs.ColorFilter(0,0,0,1,255,255,255,0), 0).to(new cjs.ColorFilter(1,1,1,1,0,0,0,0), 23,cjs.Ease.get(1)).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.shape_24}]},334).to({state:[{t:this.shape_25}]},1).to({state:[{t:this.shape_26}]},1).to({state:[{t:this.shape_27}]},1).to({state:[{t:this.shape_28}]},1).to({state:[{t:this.shape_29}]},1).to({state:[{t:this.shape_30}]},1).to({state:[{t:this.shape_31}]},1).to({state:[{t:this.shape_32}]},1).to({state:[{t:this.shape_33}]},1).to({state:[{t:this.shape_34}]},1).to({state:[{t:this.shape_35}]},1).to({state:[{t:this.shape_36}]},1).to({state:[{t:this.shape_37}]},1).to({state:[{t:this.shape_38}]},1).to({state:[{t:this.shape_39}]},1).to({state:[{t:this.shape_40}]},1).to({state:[{t:this.shape_41}]},1).to({state:[{t:this.shape_42}]},1).to({state:[{t:this.shape_43}]},1).to({state:[{t:this.shape_44}]},1).to({state:[{t:this.shape_45}]},1).to({state:[{t:this.shape_46}]},1).to({state:[{t:this.shape_46}]},1).to({state:[]},101).wait(1));

	// Text_2_1
	this.instance_5 = new lib.g_contenttxt_1("synched",0);
	this.instance_5.setTransform(337.4,45.15,1,1,0,0,0,96.5,45);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(233).to({_off:false},0).to({x:103},24,cjs.Ease.get(1)).to({_off:true},201).wait(1));
	...
	this.filterCacheList.push({instance: this.instance_4, startFrame:334, endFrame:334, x:-3, y:-4, w:136, h:33});
	this.filterCacheList.push({instance: this.instance_4, startFrame:0, endFrame:0, x:-3, y:-4, w:136, h:33});
	this.filterCacheList.push({instance: this.instance_4, startFrame:335, endFrame:357, x:-3, y:-4, w:136, h:33});
	this.filterCacheList.push({instance: this.instance_4, startFrame:358, endFrame:458, x:-3, y:-4, w:136, h:33});
	this.filterCacheList.push({instance: this.instance_4, startFrame:458, endFrame:459, x:-3, y:-4, w:136, h:33});
	this._renderFirstFrame();
