...
lib.ssMetadata = [
		{name:"index_atlas_1", frames: [[0,176,688,120],[0,298,542,56],[690,235,276,61],[648,380,262,61],[370,380,276,61],[0,356,368,61],[544,298,364,80],[0,0,746,174],[0,419,260,56],[262,443,260,56],[524,443,260,56],[912,298,100,100],[912,400,100,100],[786,443,100,100],[0,477,100,100],[748,0,200,233]]}
];
...
p.nominalBounds = new cjs.Rectangle(0,0,344,84.7);
...
p.nominalBounds = new cjs.Rectangle(0,0,373,87);
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1).to({_off:false},0).to({y:18.1},24,cjs.Ease.get(1)).to({_off:true},418).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(38).to({_off:false},0).to({y:10},18,cjs.Ease.get(1)).wait(83).to({x:658},0).to({x:668},21,cjs.Ease.get(1)).to({_off:true},1).wait(283));
	this.timeline.addTween(cjs.Tween.get(instance_1Filter_2).wait(38).to(new cjs.ColorFilter(0,0,0,1,166,25,47,0), 0).to(new cjs.ColorFilter(1,1,1,1,0,0,0,0), 18,cjs.Ease.get(1)).wait(83).to(new cjs.ColorFilter(0,0,0,1,166,25,47,0), 21,cjs.Ease.get(1)).wait(283));
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.shape_23},{t:this.shape_22},{t:this.shape_21},{t:this.shape_20}]},17).to({state:[]},144).wait(283));

	// SpeakerPic_4
	this.instance_2 = new lib.g_SpeakerPic_4("synched",0);
	this.instance_2.setTransform(638.85,36.7,0.701,0.7007,0,0,0,49.9,50);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(180).to({_off:false},0).to({x:663.35},20,cjs.Ease.get(1)).wait(67).to({startPosition:0},0).to({x:683.35},19,cjs.Ease.get(0.8)).to({_off:true},1).wait(157));
	this.timeline.addTween(cjs.Tween.get(instance_2Filter_3).wait(180).to(new cjs.ColorFilter(0,0,0,1,166,25,47,0), 0).to(new cjs.ColorFilter(1,1,1,1,0,0,0,0), 20,cjs.Ease.get(1)).wait(67).to(new cjs.ColorFilter(0,0,0,1,166,25,47,0), 19,cjs.Ease.get(0.8)).wait(157));

	// SpeakerPic_3
	this.instance_3 = new lib.g_SpeakerPic_3("synched",0);
	this.instance_3.setTransform(519.1,36.7,0.701,0.7007,0,0,0,49.9,50);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(174).to({_off:false},0).to({x:543.6},22,cjs.Ease.get(1)).wait(63).to({startPosition:0},0).to({x:563.6},24,cjs.Ease.get(0.8)).to({_off:true},4).wait(157));
	this.timeline.addTween(cjs.Tween.get(instance_3Filter_4).wait(174).to(new cjs.ColorFilter(0,0,0,1,166,25,47,0), 0).to(new cjs.ColorFilter(1,1,1,1,0,0,0,0), 22,cjs.Ease.get(1)).wait(63).to(new cjs.ColorFilter(0,0,0,1,166,25,47,0), 24,cjs.Ease.get(0.8)).wait(157));

	// SpeakerPic_2
	this.instance_4 = new lib.g_SpeakerPic_2("synched",0);
	this.instance_4.setTransform(394.35,36.7,0.701,0.7007,0,0,0,49.9,50);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(168).to({_off:false},0).to({x:418.85},24,cjs.Ease.get(1)).wait(59).to({startPosition:0},0).to({x:438.85},29,cjs.Ease.get(0.8)).to({_off:true},7).wait(157));
	this.timeline.addTween(cjs.Tween.get(instance_4Filter_5).wait(168).to(new cjs.ColorFilter(0,0,0,1,166,25,47,0), 0).to(new cjs.ColorFilter(1,1,1,1,0,0,0,0), 24,cjs.Ease.get(1)).wait(59).to(new cjs.ColorFilter(0,0,0,1,166,25,47,0), 29,cjs.Ease.get(0.8)).wait(157));

	// SpeakerPic_1
	this.instance_5 = new lib.g_SpeakerPic_1("synched",0);
	this.instance_5.setTransform(258.9,36.7,0.701,0.7007,0,0,0,49.9,50);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(161).to({_off:false},0).to({x:283.4},26,cjs.Ease.get(1)).wait(55).to({startPosition:0},0).to({x:303.4},34,cjs.Ease.get(0.8)).to({_off:true},11).wait(157));
	this.timeline.addTween(cjs.Tween.get(instance_5Filter_6).wait(161).to(new cjs.ColorFilter(0,0,0,1,166,25,47,0), 0).to(new cjs.ColorFilter(1,1,1,1,0,0,0,0), 26,cjs.Ease.get(1)).wait(55).to(new cjs.ColorFilter(0,0,0,1,166,25,47,0), 34,cjs.Ease.get(0.8)).wait(157));
	...
	this.timeline.addTween(cjs.Tween.get(mask_1).to({graphics:null,x:0,y:0}).wait(56).to({graphics:mask_1_graphics_56,x:364,y:125}).wait(388));

	// Text_1
	this.instance_6 = new lib.g_title_1("synched",0);
	this.instance_6.setTransform(255,27);
	this.instance_6._off = true;
	var instance_6Filter_7 = new cjs.ColorFilter(1,1,1,1,0,0,0,0);
	this.instance_6.filters = [instance_6Filter_7];
	this.instance_6.cache(-2,-2,348,89);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(37).to({_off:false},0).to({y:6},19,cjs.Ease.get(1)).wait(83).to({regX:111.3,regY:31.4,x:366.3,y:37.4},0).to({startPosition:0},20).to({_off:true},2).wait(283));
	this.timeline.addTween(cjs.Tween.get(instance_6Filter_7).wait(37).to(new cjs.ColorFilter(0,0,0,1,166,25,47,0), 0).to(new cjs.ColorFilter(1,1,1,1,0,0,0,0), 19,cjs.Ease.get(1)).wait(83).to(new cjs.ColorFilter(0,0,0,1,166,25,47,0), 20).wait(283));

	// Mask (mask)
	var mask_2 = new cjs.Shape();
	mask_2._off = true;
	var mask_2_graphics_290 = new cjs.Graphics().p("A/AHCIAAuDMA+BAAAIAAODg");

	this.timeline.addTween(cjs.Tween.get(mask_2).to({graphics:null,x:0,y:0}).wait(290).to({graphics:mask_2_graphics_290,x:436.025,y:45}).wait(154));

	// Text_2
	this.instance_7 = new lib.g_contenttxt_1("synched",0);
	this.instance_7.setTransform(-44.6,44.15,1,1,0,0,0,96.5,45);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(290).to({_off:false},0).to({x:344},25,cjs.Ease.get(1)).to({_off:true},128).wait(1));

	// btn_CTA
	this.instance_8 = new lib.btn_CTA();
	this.instance_8.setTransform(30,68);
	this.instance_8._off = true;
	var instance_8Filter_8 = new cjs.ColorFilter(1,1,1,1,0,0,0,0);
	this.instance_8.filters = [instance_8Filter_8];
	this.instance_8.cache(-3,-3,136,38);
	new cjs.ButtonHelper(this.instance_8, 0, 1, 2, false, new lib.btn_CTA(), 3);

	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(311).to({_off:false},0).to({y:58},23,cjs.Ease.get(1)).to({_off:true},109).wait(1));
	this.timeline.addTween(cjs.Tween.get(instance_8Filter_8).wait(311).to(new cjs.ColorFilter(0,0,0,1,255,255,255,0), 0).to(new cjs.ColorFilter(1,1,1,1,0,0,0,0), 23,cjs.Ease.get(1)).wait(1));
	...
	this.filterCacheList.push({instance: this.instance_2, startFrame:180, endFrame:180, x:-21, y:-2, w:142, h:131});
	this.filterCacheList.push({instance: this.instance_2, startFrame:0, endFrame:0, x:-21, y:-2, w:142, h:131});
	this.filterCacheList.push({instance: this.instance_2, startFrame:181, endFrame:200, x:-21, y:-2, w:142, h:131});
	this.filterCacheList.push({instance: this.instance_2, startFrame:267, endFrame:267, x:-21, y:-2, w:142, h:131});
	this.filterCacheList.push({instance: this.instance_2, startFrame:268, endFrame:286, x:-21, y:-2, w:142, h:131});
	this.filterCacheList.push({instance: this.instance_3, startFrame:174, endFrame:174, x:-17, y:-2, w:135, h:131});
	this.filterCacheList.push({instance: this.instance_3, startFrame:0, endFrame:0, x:-17, y:-2, w:135, h:131});
	this.filterCacheList.push({instance: this.instance_3, startFrame:175, endFrame:196, x:-17, y:-2, w:135, h:131});
	this.filterCacheList.push({instance: this.instance_3, startFrame:259, endFrame:259, x:-17, y:-2, w:135, h:131});
	this.filterCacheList.push({instance: this.instance_3, startFrame:260, endFrame:283, x:-17, y:-2, w:135, h:131});
	this.filterCacheList.push({instance: this.instance_4, startFrame:168, endFrame:168, x:-21, y:-2, w:142, h:131});
	this.filterCacheList.push({instance: this.instance_4, startFrame:0, endFrame:0, x:-21, y:-2, w:142, h:131});
	this.filterCacheList.push({instance: this.instance_4, startFrame:169, endFrame:192, x:-21, y:-2, w:142, h:131});
	this.filterCacheList.push({instance: this.instance_4, startFrame:251, endFrame:251, x:-21, y:-2, w:142, h:131});
	this.filterCacheList.push({instance: this.instance_4, startFrame:252, endFrame:280, x:-21, y:-2, w:142, h:131});
	this.filterCacheList.push({instance: this.instance_5, startFrame:161, endFrame:161, x:-44, y:-2, w:188, h:131});
	this.filterCacheList.push({instance: this.instance_5, startFrame:0, endFrame:0, x:-44, y:-2, w:188, h:131});
	this.filterCacheList.push({instance: this.instance_5, startFrame:162, endFrame:187, x:-44, y:-2, w:188, h:131});
	this.filterCacheList.push({instance: this.instance_5, startFrame:242, endFrame:242, x:-44, y:-2, w:188, h:131});
	this.filterCacheList.push({instance: this.instance_5, startFrame:243, endFrame:276, x:-44, y:-2, w:188, h:131});
	this.filterCacheList.push({instance: this.instance_6, startFrame:37, endFrame:37, x:-2, y:-2, w:348, h:89});
	this.filterCacheList.push({instance: this.instance_6, startFrame:0, endFrame:0, x:-2, y:-2, w:348, h:89});
	this.filterCacheList.push({instance: this.instance_6, startFrame:38, endFrame:56, x:-2, y:-2, w:348, h:89});
	this.filterCacheList.push({instance: this.instance_6, startFrame:139, endFrame:139, x:-2, y:-2, w:348, h:89});
	this.filterCacheList.push({instance: this.instance_6, startFrame:140, endFrame:159, x:-2, y:-2, w:348, h:89});
	this.filterCacheList.push({instance: this.instance_8, startFrame:311, endFrame:311, x:-3, y:-3, w:136, h:38});
	this.filterCacheList.push({instance: this.instance_8, startFrame:0, endFrame:0, x:-3, y:-3, w:136, h:38});
	this.filterCacheList.push({instance: this.instance_8, startFrame:312, endFrame:334, x:-3, y:-3, w:136, h:38});
	this.filterCacheList.push({instance: this.instance_8, startFrame:335, endFrame:443, x:-3, y:-3, w:136, h:38});
	this.filterCacheList.push({instance: this.instance_8, startFrame:443, endFrame:444, x:-3, y:-3, w:136, h:38});
	this._renderFirstFrame();

}).prototype = p = new lib.AnMovieClip();
p.nominalBounds = new cjs.Rectangle(0,0,731.8,154.7);
// library properties:
lib.properties = {
