...
if (reversed == null) { reversed = false; }
	...
	this.shape.graphics.f("#000000").s().p("AgiCbIAAj0IgxAAIAAhBICnAAIAABBIgyAAIAAD0g");
	this.shape.setTransform(186.1,60.425);
	...
	this.shape_4.setTransform(109.25,60.425);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#000000").s().p("AgvCbIAAhBIAOAAIAAizIgOAAIAAhBIBfAAIAABBIgOAAIAACzIAOAAIAABBg");
	this.shape_5.setTransform(91,60.425);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#000000").s().p("AhFCbIAAk1IBFAAIAAD0IBGAAIAABBg");
	this.shape_6.setTransform(71.35,60.425);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#000000").s().p("AAVCbIgFg9IgfAAIgGA9IhAAAIAAg0IAnkBIBdAAIAnEBIAAA0gAALAeIgJhhIgDAAIgJBhIAVAAg");
	this.shape_7.setTransform(54.1,60.425);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#000000").s().p("AhHCbIAAk1ICNAAIAABBIhIAAIAAA4IBEAAIAAA/IhEAAIAAA8IBKAAIAABBg");
	this.shape_8.setTransform(36.55,60.425);
	...
	this.shape_9.setTransform(19.35,60.425);
	...
	this.shape_10.setTransform(206.4,22.425);
	...
	this.shape_11.setTransform(187.1,22.425);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f("#000000").s().p("AhGCbIAAk1ICNAAIAABBIhIAAIAAA8IBEAAIAAA/IhEAAIAAB5g");
	this.shape_12.setTransform(169.5,22.425);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.f("#000000").s().p("AAPCbIAAh5IgdAAIAAB5IhFAAIAAk1IBFAAIAAB9IAdAAIAAh9IBFAAIAAE1g");
	this.shape_13.setTransform(145.45,22.425);

	this.shape_14 = new cjs.Shape();
	this.shape_14.graphics.f("#000000").s().p("AgxCbQgigMAAgoIAAjNQAAgoAigMIBjAAQAiAMAAAoIAABLIhFAAIAAhDIgEgEIgVAAIgEAEIAAC8IAEAFIAVAAIAEgFIAAhBIBFAAIAABKQAAAogiAMg");
	this.shape_14.setTransform(126.55,22.425);

	this.shape_15 = new cjs.Shape();
	this.shape_15.graphics.f("#000000").s().p("AAcCbIgmh5IgIAAIAAB5IhFAAIAAk1ICFAAQAiAMAAAoIAABCQAAAkgdAMIAlBjIAAAsgAgSgVIAZAAIAEgEIAAhFIgEgEIgZAAg");
	this.shape_15.setTransform(108.15,22.425);

	this.shape_16 = new cjs.Shape();
	this.shape_16.graphics.f("#000000").s().p("AAWCbIgGg9IgfAAIgGA9IhAAAIAAg0IAnkBIBdAAIAnEBIAAA0gAALAeIgJhhIgDAAIgJBhIAVAAg");
	this.shape_16.setTransform(89.1,22.425);

	this.shape_17 = new cjs.Shape();
	this.shape_17.graphics.f("#000000").s().p("AhHCbIAAk1ICNAAIAABBIhIAAIAAA4IBEAAIAAA/IhEAAIAAA8IBKAAIAABBg");
	this.shape_17.setTransform(71.55,22.425);

	this.shape_18 = new cjs.Shape();
	this.shape_18.graphics.f("#000000").s().p("AgxCbQgigMAAgoIAAg9IBFAAIAAA0IAEAFIAVAAIAEgFIAAgvIgEgGIhFggQgQgGgEgLQgFgJAAgUIAAhBQAAgoAigMIBjAAQAiAMAAAoIAAA5IhFAAIAAgxIgEgEIgVAAIgEAEIAAAtIAGAHIBDAcQAPAGAFAMQAFAJAAAUIAABGQAAAogiAMg");
	this.shape_18.setTransform(54.1,22.425);

	this.shape_19 = new cjs.Shape();
	this.shape_19.graphics.f("#000000").s().p("AhHCbIAAk1ICNAAIAABBIhIAAIAAA4IBEAAIAAA/IhEAAIAAA8IBKAAIAABBg");
	this.shape_19.setTransform(36.55,22.425);

	this.shape_20 = new cjs.Shape();
	this.shape_20.graphics.f("#000000").s().p("AAcCbIgnh5IgHAAIAAB5IhFAAIAAk1ICGAAQAhAMAAAoIAABCQAAAkgdAMIAlBjIAAAsgAgSgVIAZAAIAEgEIAAhFIgEgEIgZAAg");
	this.shape_20.setTransform(19.35,22.425);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_20},{t:this.shape_19},{t:this.shape_18},{t:this.shape_17},{t:this.shape_16},{t:this.shape_15},{t:this.shape_14},{t:this.shape_13},{t:this.shape_12},{t:this.shape_11},{t:this.shape_10},{t:this.shape_9},{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

	// Bg
	this.shape_21 = new cjs.Shape();
	this.shape_21.graphics.f("#FFFFFF").s().p("AzbGbIAAm+IgBAAIAAl3MAm5AAAIAAG7IjJAAIAAF6g");
	this.shape_21.setTransform(98.25,41.125);
...
p.nominalBounds = new cjs.Rectangle(-26.2,0,250.2,86.5);
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/Photo.jpg?1789669764020", id:"Photo"}
	],
	preloads: []
};
