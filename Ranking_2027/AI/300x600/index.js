...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(230).to({_off:false},0).to({x:134.95,alpha:1},30,cjs.Ease.quadInOut).wait(80).to({mode:"single"},0).to({x:124.95,alpha:0},31,cjs.Ease.quadInOut).to({_off:true},1).wait(28));
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/Photo.jpg?1789505836033", id:"Photo"}
	],
	preloads: []
};
