...
lib.ssMetadata = [
		{name:"index_atlas_1", frames: [[0,0,582,316],[0,318,524,232],[584,670,160,80],[302,688,162,41],[302,731,162,41],[302,552,280,66],[584,602,280,66],[302,620,280,66],[584,0,300,600],[0,552,300,359]]}
];
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.shape_16}]},131).to({state:[{t:this.shape_17}]},1).to({state:[{t:this.shape_18}]},1).to({state:[{t:this.shape_19}]},1).to({state:[{t:this.shape_20}]},1).to({state:[{t:this.shape_21}]},1).to({state:[{t:this.shape_22}]},1).to({state:[{t:this.shape_23}]},1).to({state:[{t:this.shape_24}]},1).to({state:[{t:this.shape_25}]},1).to({state:[{t:this.shape_26}]},1).to({state:[{t:this.shape_27}]},1).to({state:[{t:this.shape_28}]},1).to({state:[{t:this.shape_29}]},1).to({state:[]},1).to({state:[{t:this.shape_29}]},141).to({state:[{t:this.shape_30}]},1).to({state:[{t:this.shape_31}]},1).to({state:[{t:this.shape_32}]},1).to({state:[{t:this.shape_33}]},1).to({state:[{t:this.shape_34}]},1).to({state:[{t:this.shape_35}]},1).to({state:[{t:this.shape_36}]},1).to({state:[{t:this.shape_37}]},1).to({state:[{t:this.shape_38}]},1).to({state:[{t:this.shape_39}]},1).to({state:[{t:this.shape_40}]},1).to({state:[{t:this.shape_41}]},1).to({state:[{t:this.shape_16}]},1).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(18).to({_off:false},0).to({_off:true},106).wait(176));
	...
	this.timeline.addTween(cjs.Tween.get(mask_1).to({graphics:null,x:0,y:0}).wait(1).to({graphics:mask_1_graphics_1,x:149.9994,y:299.9822}).wait(299));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(33).to({_off:false},0).to({x:139.5},13,cjs.Ease.get(1)).to({_off:true},78).wait(176));

	// Red_Bg
	this.shape_42 = new cjs.Shape();
	this.shape_42.graphics.f("#CC0633").s().p("A3bAyIAAhjMAu3AAAIAABjg");
	this.shape_42.setTransform(150,-6);

	this.shape_43 = new cjs.Shape();
	this.shape_43.graphics.f("#CC0633").s().p("A3bCtIAAlZMAu3AAAIAAFZg");
	this.shape_43.setTransform(150,7.65);

	this.shape_44 = new cjs.Shape();
	this.shape_44.graphics.f("#CC0633").s().p("A3bEeIAAo8MAu3AAAIAAI8g");
	this.shape_44.setTransform(150,20.4);

	this.shape_45 = new cjs.Shape();
	this.shape_45.graphics.f("#CC0633").s().p("A3bGIIAAsPMAu3AAAIAAMPg");
	this.shape_45.setTransform(150,32.15);

	this.shape_46 = new cjs.Shape();
	this.shape_46.graphics.f("#CC0633").s().p("A3bHpIAAvRMAu3AAAIAAPRg");
	this.shape_46.setTransform(150,43);

	this.shape_47 = new cjs.Shape();
	this.shape_47.graphics.f("#CC0633").s().p("A3bJCIAAyDMAu3AAAIAASDg");
	this.shape_47.setTransform(150,52.875);

	this.shape_48 = new cjs.Shape();
	this.shape_48.graphics.f("#CC0633").s().p("A3bKSIAA0jMAu3AAAIAAUjg");
	this.shape_48.setTransform(150,61.85);

	this.shape_49 = new cjs.Shape();
	this.shape_49.graphics.f("#CC0633").s().p("A3bLaIAA2zMAu3AAAIAAWzg");
	this.shape_49.setTransform(150,69.825);

	this.shape_50 = new cjs.Shape();
	this.shape_50.graphics.f("#CC0633").s().p("A3bMZIAA4xMAu3AAAIAAYxg");
	this.shape_50.setTransform(150,76.925);

	this.shape_51 = new cjs.Shape();
	this.shape_51.graphics.f("#CC0633").s().p("A3bNQIAA6fMAu3AAAIAAafg");
	this.shape_51.setTransform(150,83.05);

	this.shape_52 = new cjs.Shape();
	this.shape_52.graphics.f("#CC0633").s().p("A3bN+IAA77MAu3AAAIAAb7g");
	this.shape_52.setTransform(150,88.225);

	this.shape_53 = new cjs.Shape();
	this.shape_53.graphics.f("#CC0633").s().p("A3bOkIAA9IMAu3AAAIAAdIg");
	this.shape_53.setTransform(150,92.45);

	this.shape_54 = new cjs.Shape();
	this.shape_54.graphics.f("#CC0633").s().p("A3bPCIAA+DMAu3AAAIAAeDg");
	this.shape_54.setTransform(150,95.75);

	this.shape_55 = new cjs.Shape();
	this.shape_55.graphics.f("#CC0633").s().p("A3bPXIAA+tMAu3AAAIAAetg");
	this.shape_55.setTransform(150,98.125);

	this.shape_56 = new cjs.Shape();
	this.shape_56.graphics.f("#CC0633").s().p("A3bPkIAA/HMAu3AAAIAAfHg");
	this.shape_56.setTransform(150,99.525);

	this.shape_57 = new cjs.Shape();
	this.shape_57.graphics.f("#CC0633").s().p("A3bPoIAA/PMAu3AAAIAAfPg");
	this.shape_57.setTransform(150,100);

	var maskedShapeInstanceList = [this.shape_42,this.shape_43,this.shape_44,this.shape_45,this.shape_46,this.shape_47,this.shape_48,this.shape_49,this.shape_50,this.shape_51,this.shape_52,this.shape_53,this.shape_54,this.shape_55,this.shape_56,this.shape_57];

	for(var shapedInstanceItr = 0; shapedInstanceItr < maskedShapeInstanceList.length; shapedInstanceItr++) {
		maskedShapeInstanceList[shapedInstanceItr].mask = mask_1;
	}

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.shape_42}]},18).to({state:[{t:this.shape_43}]},1).to({state:[{t:this.shape_44}]},1).to({state:[{t:this.shape_45}]},1).to({state:[{t:this.shape_46}]},1).to({state:[{t:this.shape_47}]},1).to({state:[{t:this.shape_48}]},1).to({state:[{t:this.shape_49}]},1).to({state:[{t:this.shape_50}]},1).to({state:[{t:this.shape_51}]},1).to({state:[{t:this.shape_52}]},1).to({state:[{t:this.shape_53}]},1).to({state:[{t:this.shape_54}]},1).to({state:[{t:this.shape_55}]},1).to({state:[{t:this.shape_56}]},1).to({state:[{t:this.shape_57}]},1).to({state:[]},91).wait(176));
	...
	this.instance_2.cache(-2,-2,304,604);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(2).to({_off:false},0).to({startPosition:0},16,cjs.Ease.get(1)).to({_off:true},106).wait(176));
	this.timeline.addTween(cjs.Tween.get(instance_2Filter_1).wait(2).to(new cjs.ColorFilter(1,1,1,1,255,255,255,0), 0).to(new cjs.ColorFilter(1,1,1,1,0,0,0,0), 16,cjs.Ease.get(1)).wait(176));

	// Mask (mask)
	var mask_2 = new cjs.Shape();
	mask_2._off = true;
	var mask_2_graphics_131 = new cjs.Graphics().p("EgXbAu4MAAAhdvMAu3AAAMAAABdvg");

	this.timeline.addTween(cjs.Tween.get(mask_2).to({graphics:null,x:0,y:0}).wait(131).to({graphics:mask_2_graphics_131,x:150,y:300}).wait(169));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(196).to({_off:false},0).to({y:544.5},16,cjs.Ease.get(0.9)).wait(88));
	this.timeline.addTween(cjs.Tween.get(instance_3Filter_2).wait(196).to(new cjs.ColorFilter(0,0,0,1,255,255,255,0), 0).to(new cjs.ColorFilter(1,1,1,1,0,0,0,0), 16,cjs.Ease.get(0.9)).wait(88));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(184).to({_off:false},0).to({y:0.1},13,cjs.Ease.get(1)).wait(103));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(170).to({_off:false},0).to({x:-2.5},14,cjs.Ease.get(1)).wait(116));

	// Red_Bg
	this.shape_58 = new cjs.Shape();
	this.shape_58.graphics.f("#CC0633").s().p("AgrMKIAA4UIAoAAIAAHoIAvAAIAAI5IgvAAIAAHzg");
	this.shape_58.setTransform(-7.075,149.6);

	this.shape_59 = new cjs.Shape();
	this.shape_59.graphics.f("#CC0633").s().p("AiCMKIAA4UIBZAAIAAHoICsAAIAAI5IgzAAIAAHzg");
	this.shape_59.setTransform(2.275,149.6);

	this.shape_60 = new cjs.Shape();
	this.shape_60.graphics.f("#CC0633").s().p("AjWMKIAA4UICHAAIAAHoIEmAAIAAI5Ig2AAIAAHzg");
	this.shape_60.setTransform(11.3,149.6);

	this.shape_61 = new cjs.Shape();
	this.shape_61.graphics.f("#CC0633").s().p("AknMKIAA4UIC0AAIAAHoIGbAAIAAI5Ig5AAIAAHzg");
	this.shape_61.setTransform(20.025,149.6);

	this.shape_62 = new cjs.Shape();
	this.shape_62.graphics.f("#CC0633").s().p("Al2MKIAA4UIDgAAIAAHoIIMAAIAAI5Ig7AAIAAHzg");
	this.shape_62.setTransform(28.45,149.6);

	this.shape_63 = new cjs.Shape();
	this.shape_63.graphics.f("#CC0633").s().p("AnBMKIAA4UIEJAAIAAHoIJ6AAIAAI5Ig+AAIAAHzg");
	this.shape_63.setTransform(36.55,149.6);

	this.shape_64 = new cjs.Shape();
	this.shape_64.graphics.f("#CC0633").s().p("AoKMKIAA4UIEyAAIAAHoILiAAIAAI5IhBAAIAAHzg");
	this.shape_64.setTransform(44.35,149.6);

	this.shape_65 = new cjs.Shape();
	this.shape_65.graphics.f("#CC0633").s().p("ApPMKIAA4UIFZAAIAAHoINGAAIAAI5IhEAAIAAHzg");
	this.shape_65.setTransform(51.825,149.6);

	this.shape_66 = new cjs.Shape();
	this.shape_66.graphics.f("#CC0633").s().p("AqSMKIAA4UIF+AAIAAHoIOnAAIAAI5IhHAAIAAHzg");
	this.shape_66.setTransform(59,149.6);

	this.shape_67 = new cjs.Shape();
	this.shape_67.graphics.f("#CC0633").s().p("ArSMKIAA4UIGhAAIAAHoIQEAAIAAI5IhJAAIAAHzg");
	this.shape_67.setTransform(65.875,149.6);

	this.shape_68 = new cjs.Shape();
	this.shape_68.graphics.f("#CC0633").s().p("AsPMKIAA4UIHDAAIAAHoIRcAAIAAI5IhLAAIAAHzg");
	this.shape_68.setTransform(72.425,149.6);

	this.shape_69 = new cjs.Shape();
	this.shape_69.graphics.f("#CC0633").s().p("AtJMKIAA4UIHkAAIAAHoISvAAIAAI5IhNAAIAAHzg");
	this.shape_69.setTransform(78.65,149.6);

	this.shape_70 = new cjs.Shape();
	this.shape_70.graphics.f("#CC0633").s().p("AuAMKIAA4UIICAAIAAHoIT/AAIAAI5IhPAAIAAHzg");
	this.shape_70.setTransform(84.575,149.6);

	this.shape_71 = new cjs.Shape();
	this.shape_71.graphics.f("#CC0633").s().p("Au1MKIAA4UIIgAAIAAHoIVKAAIAAI5IhRAAIAAHzg");
	this.shape_71.setTransform(90.2,149.6);

	this.shape_72 = new cjs.Shape();
	this.shape_72.graphics.f("#CC0633").s().p("AvmMKIAA4UII7AAIAAHoIWSAAIAAI5IhTAAIAAHzg");
	this.shape_72.setTransform(95.5,149.6);

	this.shape_73 = new cjs.Shape();
	this.shape_73.graphics.f("#CC0633").s().p("AwVMKIAA4UIJVAAIAAHoIXVAAIAAI5IhUAAIAAHzg");
	this.shape_73.setTransform(100.5,149.6);

	this.shape_74 = new cjs.Shape();
	this.shape_74.graphics.f("#CC0633").s().p("AxAMKIAA4UIJsAAIAAHoIYVAAIAAI5IhWAAIAAHzg");
	this.shape_74.setTransform(105.2,149.6);

	this.shape_75 = new cjs.Shape();
	this.shape_75.graphics.f("#CC0633").s().p("AxpMKIAA4UIKEAAIAAHoIZPAAIAAI5IhYAAIAAHzg");
	this.shape_75.setTransform(109.575,149.6);

	this.shape_76 = new cjs.Shape();
	this.shape_76.graphics.f("#CC0633").s().p("AyOMKIAA4UIKXAAIAAHoIaGAAIAAI5IhZAAIAAHzg");
	this.shape_76.setTransform(113.65,149.6);

	this.shape_77 = new cjs.Shape();
	this.shape_77.graphics.f("#CC0633").s().p("AyyMKIAA4UIKsAAIAAHoIa5AAIAAI5IhbAAIAAHzg");
	this.shape_77.setTransform(117.425,149.6);

	this.shape_78 = new cjs.Shape();
	this.shape_78.graphics.f("#CC0633").s().p("AzSMKIAA4UIK+AAIAAHoIbnAAIAAI5IhcAAIAAHzg");
	this.shape_78.setTransform(120.85,149.6);

	this.shape_79 = new cjs.Shape();
	this.shape_79.graphics.f("#CC0633").s().p("AzvMKIAA4UILOAAIAAHoIcRAAIAAI5IhdAAIAAHzg");
	this.shape_79.setTransform(124,149.6);

	this.shape_80 = new cjs.Shape();
	this.shape_80.graphics.f("#CC0633").s().p("A0JMKIAA4UILcAAIAAHoIc3AAIAAI5IhdAAIAAHzg");
	this.shape_80.setTransform(126.825,149.6);

	this.shape_81 = new cjs.Shape();
	this.shape_81.graphics.f("#CC0633").s().p("A0hMKIAA4UILqAAIAAHoIdZAAIAAI5IhfAAIAAHzg");
	this.shape_81.setTransform(129.325,149.6);

	this.shape_82 = new cjs.Shape();
	this.shape_82.graphics.f("#CC0633").s().p("A01MKIAA4UIL0AAIAAHoId3AAIAAI5IhfAAIAAHzg");
	this.shape_82.setTransform(131.55,149.6);

	this.shape_83 = new cjs.Shape();
	this.shape_83.graphics.f("#CC0633").s().p("A1HMKIAA4UIL+AAIAAHoIeRAAIAAI5IhgAAIAAHzg");
	this.shape_83.setTransform(133.45,149.6);

	this.shape_84 = new cjs.Shape();
	this.shape_84.graphics.f("#CC0633").s().p("A1WMKIAA4UIMHAAIAAHoIemAAIAAI5IhhAAIAAHzg");
	this.shape_84.setTransform(135.025,149.6);

	this.shape_85 = new cjs.Shape();
	this.shape_85.graphics.f("#CC0633").s().p("A1hMKIAA4UIMNAAIAAHoIe2AAIAAI5IhhAAIAAHzg");
	this.shape_85.setTransform(136.3,149.6);

	this.shape_86 = new cjs.Shape();
	this.shape_86.graphics.f("#CC0633").s().p("A1rMKIAA4UIMTAAIAAHoIfEAAIAAI5IhiAAIAAHzg");
	this.shape_86.setTransform(137.275,149.6);

	this.shape_87 = new cjs.Shape();
	this.shape_87.graphics.f("#CC0633").s().p("A1xMKIAA4UIMWAAIAAHoIfNAAIAAI5IhiAAIAAHzg");
	this.shape_87.setTransform(137.925,149.6);
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.shape_58}]},155).to({state:[{t:this.shape_59}]},1).to({state:[{t:this.shape_60}]},1).to({state:[{t:this.shape_61}]},1).to({state:[{t:this.shape_62}]},1).to({state:[{t:this.shape_63}]},1).to({state:[{t:this.shape_64}]},1).to({state:[{t:this.shape_65}]},1).to({state:[{t:this.shape_66}]},1).to({state:[{t:this.shape_67}]},1).to({state:[{t:this.shape_68}]},1).to({state:[{t:this.shape_69}]},1).to({state:[{t:this.shape_70}]},1).to({state:[{t:this.shape_71}]},1).to({state:[{t:this.shape_72}]},1).to({state:[{t:this.shape_73}]},1).to({state:[{t:this.shape_74}]},1).to({state:[{t:this.shape_75}]},1).to({state:[{t:this.shape_76}]},1).to({state:[{t:this.shape_77}]},1).to({state:[{t:this.shape_78}]},1).to({state:[{t:this.shape_79}]},1).to({state:[{t:this.shape_80}]},1).to({state:[{t:this.shape_81}]},1).to({state:[{t:this.shape_82}]},1).to({state:[{t:this.shape_83}]},1).to({state:[{t:this.shape_84}]},1).to({state:[{t:this.shape_85}]},1).to({state:[{t:this.shape_86}]},1).to({state:[{t:this.shape_87}]},1).wait(116));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(131).to({_off:false},0).wait(169));

	this.filterCacheList = [];
	this.filterCacheList.push({instance: this.instance_2, startFrame:2, endFrame:2, x:-2, y:-2, w:304, h:604});
	this.filterCacheList.push({instance: this.instance_2, startFrame:0, endFrame:0, x:-2, y:-2, w:304, h:604});
	this.filterCacheList.push({instance: this.instance_2, startFrame:3, endFrame:18, x:-2, y:-2, w:304, h:604});
	this.filterCacheList.push({instance: this.instance_3, startFrame:196, endFrame:196, x:-3, y:-3, w:172, h:57});
	this.filterCacheList.push({instance: this.instance_3, startFrame:0, endFrame:0, x:-3, y:-3, w:172, h:57});
	this.filterCacheList.push({instance: this.instance_3, startFrame:197, endFrame:212, x:-3, y:-3, w:172, h:57});
	this.filterCacheList.push({instance: this.instance_3, startFrame:212, endFrame:300, x:-3, y:-3, w:172, h:57});
	this._renderFirstFrame();
